                ...
                [
                    ...
                    'content' => [
                        [
                            ...
                            the prompt should be comprehensive, describing the visual elements, style, mood, and any other relevant details. make it detailed enough that someone could use it to generate a similar image.
                            You MUST preserve aspect ratio exact as the original image or very close to it.'
                        ],
                        [
                            'type' => 'image_url',
                            'image_url' => [
